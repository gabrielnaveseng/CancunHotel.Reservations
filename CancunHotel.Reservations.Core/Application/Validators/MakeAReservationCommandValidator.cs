...
{
    public class MakeAReservationCommandValidator : AbstractValidator<MakeAReservationCommand>
    {
        public MakeAReservationCommandValidator()
        {
            ...
            RuleFor(command => command.EndReservationPeriod.Subtract(command.CreatedAt.Date))
